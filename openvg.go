...
package openvg
/*
#cgo CFLAGS:  -I shivavg -I omx -I omx/include -I/opt/vc/include -I/opt/vc/include/interface/vmcs_host/linux -I/opt/vc/include/interface/vcos/pthreads
...
#cgo arm LDFLAGS:  -L/opt/vc/lib/ -lGLESv2 -lEGL -lopenmaxil -lbcm_host -lvcos -lvchiq_arm -lpthread -lrt -lm -ljpeg
#include "VG/openvg.h"
#include "VG/vgu.h"
#include <stdlib.h>
#ifdef __arm__
