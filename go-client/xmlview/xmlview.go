// Source from vgdeck: slide decks for OpenVG
// The main difference is that lists are interpreted diffferently, data is received from an xml file instead of the actual data items 
// Also images of type "video" will create a video player that plays videos from playlist.xml
package main
